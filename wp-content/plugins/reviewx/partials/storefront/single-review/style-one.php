<?php
    ...
    // This condition for [rvx-woo-reviews] shortcode && check divi
    ...
    <?php //if( !isset($reviewx_shortcode) || (isset($reviewx_shortcode) && ( isset($reviewx_shortcode['rx_filter']) ? $reviewx_shortcode['rx_filter'] : '' !='off' ) ) ) {
        if( \ReviewX_Helper::shortcode_divi_review_filter(get_the_ID(), $reviewx_shortcode) ) {             
            ?> 
            ...
            <div class="rx_listing_style_1">
                <ul class="rx_listing" id="rx-commentlist">
                    <?php
                        ...
                        if ( ! empty( $comments2 ) && is_array( $comments2 ) ) {
    ...
    //if( ( !isset($reviewx_shortcode) || (isset($reviewx_shortcode) && $reviewx_shortcode['rx_form'] !='off' ) ) ) { ?>
    ...
    <?php 
        ...
        <?php else : ?>            
            <?php 
                if( get_post_type( get_the_ID() ) == 'product' || get_post_type( get_the_ID() ) == 'download') {
                    ?>
                    <div id="rx_comment_form__wrapper" class="rx-review-form-area-style-1 rx_comment_form__wrapper">
                        <div id="review_form_wrapper">                        
